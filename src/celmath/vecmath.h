...
public:
    ...
    inline Point3 &operator+=(const Eigen::Vector3<T> &);
    inline Point3 &operator-=(const Eigen::Vector3<T> &);
...
public:
    ...
    inline Point2 &operator+=(const Eigen::Vector2<T> &);
    inline Point2 &operator-=(const Eigen::Vector2<T> &);

    inline T distanceTo(const Point2 &) const;
    inline T distanceToSquared(const Point2 &) const;
...
public:
    Matrix4();
    Matrix4(
        const Eigen::Vector4<T> &,
        const Eigen::Vector4<T> &,
        const Eigen::Vector4<T> &,
        const Eigen::Vector4<T> &);
    Matrix4(const Matrix4<T> &m);

    inline const Eigen::Vector4<T> &operator[](int) const;
    inline Eigen::Vector4<T>        row(int) const;
    inline Eigen::Vector4<T>        column(int) const;

    static Matrix4<T> identity();
    static Matrix4<T> translation(const Point3<T> &);
    static Matrix4<T> translation(const Eigen::Vector3<T> &);
    static Matrix4<T> rotation(const Eigen::Vector3<T> &, T);
    static Matrix4<T> xrotation(T);
    static Matrix4<T> yrotation(T);
    static Matrix4<T> zrotation(T);
    static Matrix4<T> scaling(const Eigen::Vector3<T> &);
...
public:
    Matrix3();
    Matrix3(const Eigen::Vector3<T> &, const Eigen::Vector3<T> &, const Eigen::Vector3<T> &);
    template<class U>
    ...
    static Matrix3<T> scaling(const Eigen::Vector3<T> &);
    static Matrix3<T> scaling(T);

    inline const Eigen::Vector3<T> &operator[](int) const;
    inline Eigen::Vector3<T>        row(int) const;
    inline Eigen::Vector3<T>        column(int) const;
...
template<class T>
Point3<T>::Point3(const Point3<T> &p) : x(p.x), y(p.y), z(p.z)
{
}
...
template<class T>
Point3<T>::Point3(T *p) : x(p[0]), y(p[1]), z(p[2])
{
}
...
template<class T>
Point3<T> &
Point3<T>::operator+=(const Eigen::Vector3<T> &v)
{
    x += v.x;
    y += v.y;
    z += v.z;
...
template<class T>
Point3<T>
operator+(const Point3<T> &p, const Eigen::Vector3<T> &v)
{
...
template<class T>
T
Point3<T>::distanceTo(const Point3 &p) const
{
    return (T)sqrt((p.x - x) * (p.x - x) + (p.y - y) * (p.y - y) + (p.z - z) * (p.z - z));
}

template<class T>
T
Point3<T>::distanceToSquared(const Point3 &p) const
{
...
template<class T>
T
Point3<T>::distanceFromOrigin() const
{
...
template<class T>
T
Point3<T>::distanceFromOriginSquared() const
{
    return x * x + y * y + z * z;
}
...
template<class T>
Point2<T> &
Point2<T>::operator+=(const Eigen::Vector2<T> &v)
{
    x += v.x;
    y += v.y;
    return *this;
...
template<class T>
T
Point2<T>::distanceTo(const Point2 &p) const
{
    return (T)sqrt((p.x - x) * (p.x - x) + (p.y - y) * (p.y - y));
}

template<class T>
T
Point2<T>::distanceToSquared(const Point2 &p) const
{
...
template<class T>
Matrix3<T>::Matrix3(const Eigen::Vector3<T> &r0, const Eigen::Vector3<T> &r1, const Eigen::Vector3<T> &r2)
{
    r[0] = r0;
    r[1] = r1;
    r[2] = r2;
...
template<class T>
const Eigen::Vector3<T> &
Matrix3<T>::operator[](int n) const
{
...
template<class T>
Eigen::Vector3<T>
operator*(const Matrix3<T> &m, const Eigen::Vector3<T> &v)
{
    return Vector3<T>(
...
template<class T>
Eigen::Vector3<T>
operator*(const Eigen::Vector3<T> &v, const Matrix3<T> &m)
{
    return Vector3<T>(
...
template<class T>
Point3<T>
operator*(const Matrix3<T> &m, const Point3<T> &p)
{
    return Point3<T>(
        m.r[0].x * p.x + m.r[0].y * p.y + m.r[0].z * p.z,
...
template<class T>
Point3<T>
operator*(const Point3<T> &p, const Matrix3<T> &m)
{
    return Point3<T>(
        m.r[0].x * p.x + m.r[1].x * p.y + m.r[2].x * p.z,
...
template<class T>
Matrix3<T>
operator*(const Matrix3<T> &a, const Matrix3<T> &b)
{
#define MATMUL(R, C) (a[R].x * b[0].C + a[R].y * b[1].C + a[R].z * b[2].C)
    return Matrix3<T>(
        Vector3<T>(MATMUL(0, x), MATMUL(0, y), MATMUL(0, z)),
...
operator+(const Matrix3<T> &a, const Matrix3<T> &b)
{
    return Matrix3<T>(a.r[0] + b.r[0], a.r[1] + b.r[1], a.r[2] + b.r[2]);
}
...
{
    return (
        r[0].x * r[1].y * r[2].z + r[0].y * r[1].z * r[2].x + r[0].z * r[1].x * r[2].y
        - r[0].z * r[1].y * r[2].x - r[0].x * r[1].z * r[2].y - r[0].y * r[1].x * r[2].z);
}
...
template<class T>
Matrix3<T>
Matrix3<T>::xrotation(T angle)
{
    T c = (T)cos(angle);
    T s = (T)sin(angle);

    return Matrix3<T>(Vector3<T>(1, 0, 0), Vector3<T>(0, c, -s), Vector3<T>(0, s, c));
}

template<class T>
Matrix3<T>
Matrix3<T>::yrotation(T angle)
{
    T c = (T)cos(angle);
    T s = (T)sin(angle);

    return Matrix3<T>(Vector3<T>(c, 0, s), Vector3<T>(0, 1, 0), Vector3<T>(-s, 0, c));
}

template<class T>
Matrix3<T>
Matrix3<T>::zrotation(T angle)
{
    T c = (T)cos(angle);
    T s = (T)sin(angle);

    return Matrix3<T>(Vector3<T>(c, -s, 0), Vector3<T>(s, c, 0), Vector3<T>(0, 0, 1));
}

template<class T>
Matrix3<T>
Matrix3<T>::scaling(const Eigen::Vector3<T> &scale)
{
    return Matrix3<T>(
        Vector3<T>(scale.x, 0, 0),
...
template<class T>
Matrix4<T>::Matrix4(
    const Eigen::Vector4<T> &v0,
    const Eigen::Vector4<T> &v1,
    const Eigen::Vector4<T> &v2,
    const Eigen::Vector4<T> &v3)
{
    r[0] = v0;
    r[1] = v1;
    r[2] = v2;
...
template<class T>
const Eigen::Vector4<T> &
Matrix4<T>::operator[](int n) const
{
    return r[n];
...
template<class T>
Matrix4<T>
Matrix4<T>::translation(const Point3<T> &p)
{
    return Matrix4<T>(
        Vector4<T>(1, 0, 0, 0),
        Vector4<T>(0, 1, 0, 0),
...
template<class T>
Matrix4<T>
Matrix4<T>::translation(const Eigen::Vector3<T> &v)
{
    return Matrix4<T>(
        Vector4<T>(1, 0, 0, 0),
        Vector4<T>(0, 1, 0, 0),
...
template<class T>
void
Matrix4<T>::translate(const Point3<T> &p)
{
    r[3].x += p.x;
    r[3].y += p.y;
    r[3].z += p.z;
...
template<class T>
Matrix4<T>
Matrix4<T>::rotation(const Eigen::Vector3<T> &axis, T angle)
{
    T c = (T)cos(angle);
    T s = (T)sin(angle);
    T t = 1 - c;
...
template<class T>
Matrix4<T>
Matrix4<T>::scaling(const Eigen::Vector3<T> &scale)
{
    return Matrix4<T>(
...
template<class T>
Eigen::Vector3<T>
operator*(const Matrix4<T> &m, const Eigen::Vector3<T> &v)
{
    return Vector3<T>(
        m.r[0].x * v.x + m.r[0].y * v.y + m.r[0].z * v.z,
        m.r[1].x * v.x + m.r[1].y * v.y + m.r[1].z * v.z,
...
template<class T>
Eigen::Vector3<T>
operator*(const Eigen::Vector3<T> &v, const Matrix4<T> &m)
{
    return Vector3<T>(
        m.r[0].x * v.x + m.r[1].x * v.y + m.r[2].x * v.z,
        m.r[0].y * v.x + m.r[1].y * v.y + m.r[2].y * v.z,
...
template<class T>
Point3<T>
operator*(const Matrix4<T> &m, const Point3<T> &p)
{
    return Point3<T>(
        m.r[0].x * p.x + m.r[0].y * p.y + m.r[0].z * p.z + m.r[0].w,
...
template<class T>
Point3<T>
operator*(const Point3<T> &p, const Matrix4<T> &m)
{
    return Point3<T>(
        m.r[0].x * p.x + m.r[1].x * p.y + m.r[2].x * p.z + m.r[3].x,
...
template<class T>
Eigen::Vector4<T>
operator*(const Matrix4<T> &m, const Eigen::Vector4<T> &v)
{
    return Vector4<T>(
...
template<class T>
Eigen::Vector4<T>
operator*(const Eigen::Vector4<T> &v, const Matrix4<T> &m)
{
    return Vector4<T>(
        m.r[0].x * v.x + m.r[1].x * v.y + m.r[2].x * v.z + m.r[3].x * v.w,
...
{
    return Matrix4<T>(
        Vector4<T>(r[0].x, r[1].x, r[2].x, r[3].x),
...
template<class T>
Matrix4<T>
operator*(const Matrix4<T> &a, const Matrix4<T> &b)
{
#define MATMUL(R, C) (a[R].x * b[0].C + a[R].y * b[1].C + a[R].z * b[2].C + a[R].w * b[3].C)
    return Matrix4<T>(
        Vector4<T>(MATMUL(0, x), MATMUL(0, y), MATMUL(0, z), MATMUL(0, w)),
